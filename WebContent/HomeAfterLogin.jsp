...
<head>
<meta charset="UTF-8">
<title>Keep Journote Logged Homepage</title>
...
.divcss6{background-color:#F5F5F5;border-color:#FFFFFF;padding-right:10px;height:190px;}
</style>
...
$("#login").click(function(){
	location.href="HomeAfterLogin.jsp";
	});
}); 
</script>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="HomeAfterLogin.jsp?username=<%=usernamevalue %>">Home <span class="sr-only">(current)</span></a></li>
...
<div class="container">
	   <div class="row align-items-center">
          ...
          Write your journal and note here, treasure your memories and go further."
			...
			<div class="row ">
			 <div class="col-md-6">
			   <a type="button" href="WriteJournal.jsp?username=<%=usernamevalue %>" class="btn btn-mysample1 btn-lg btn-block  w-100 mb-3"
			   onclick=# >Write Journal</a>
			 </div>
			 <div class="col-md-6">
			   <a type="button" href="WriteNote.jsp?username=<%=usernamevalue %>" class="btn btn-mysample1 btn-lg btn-block  w-100 mb-3"
			   onclick=# >Keep Note</a>
			 </div>
			</div>
		</div>
