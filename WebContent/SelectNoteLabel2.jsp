...
<nav class="navbar navbar-default navbar-static-top">
 ...
 <%
	...
	rs=sql.executeQuery("select * from journote where username= '"+usernamevalue+"' and label='2' and isjournal='0' order by tag desc");
	...
	<div class="row">
		<div style="float:left">
   		...
   		<div style="float:left;">
   			...
   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   			<a href="SelectNoteLabel2.jsp?username=<%=usernamevalue%>" type="submit" class="btn btn-mysample1 active" >label2</a>
   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
