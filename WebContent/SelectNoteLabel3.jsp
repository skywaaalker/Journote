...
<nav class="navbar navbar-default navbar-static-top">
 ...
 <%
	...
	rs=sql.executeQuery("select * from journote where username= '"+usernamevalue+"' and label='3' and isjournal='0' order by tag desc");
...
<%--    		<div style="float:left">
   		...
   		<div style="float:left;">
   			...
   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   			<a href="SelectNoteLabel3.jsp?username=<%=usernamevalue%>" type="submit" class="btn btn-mysample1 active" >label3</a>
   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
