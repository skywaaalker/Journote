...
<nav class="navbar navbar-default navbar-static-top">
 ...
 <%
	...
	rs=sql.executeQuery("select * from journote where username= '"+usernamevalue+"'and isjournal='0' order by tag desc");
	...
	<div class="row">
		<div style="float:left">
   		...
   		<div style="float:left;">
   			...
   			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   			<a href="SelectNoteLabel5.jsp?username=<%=usernamevalue%>" type="submit" class="btn btn-mysample1" >label5</a>
   		</div>
   		<form>
	</div>
	<div class="row mb-4">
		...
		<div class="col-md-3" style="height:150px;">
			<div class="row no-gutters border-primary rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
				<div class =col p-4 d-flex flex-column position-static>
					...
					<h7 style="padding-bottom:5px;">label:<%=rs.getInt("label") %></h7>
					...
					<a href="ShowNoteDetail.jsp?noteid=<%=rs.getInt(1)%>&username=<%=usernamevalue%>&notetitle=<%=rs.getString("title")%>&notecontent=<%=rs.getString("content")%>&notelabel=<%=rs.getInt("label") %>" class="streched-link">continue reading &edit</a>
