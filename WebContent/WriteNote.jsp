...
<div class="container">
	<form action="CheckWriteNote.jsp?username=<%=usernamevalue %>" method="post" name="frmWriteNote">
	<div class ="row">
		...
		<!-- <button type="button" class="btn btn-lg btn-primary btn-clock">jjfdsfsdfsf</button> -->
			...
			<div><input type="text" class="form-contorl" name="NoteTitle" id="NoteTitle" 
			style="width:100%" placeholder="Add note title here"></div>
			<br>
			<div id="div2" class="text" placeholder="hello" style="display:none"> 
			</div>
			<div style="">
				<textarea id="text11" name="NoteText"style="width:100%; height:200px;resize:none" placeholder="Add note content here"></textarea>
			</div>
			<br>
			<div style="text-align:center">
				<div style="display:inline-block;">
               	 	<select name="NoteLabel" style="width:40px;height:20px;font-size:10px;">
...
<script lang="javascript">
	...
	function validateWrite() {
		...
		if ((title == '') || (title == "Add note title here")) {
			alert("Input title");
			return false;
		}
